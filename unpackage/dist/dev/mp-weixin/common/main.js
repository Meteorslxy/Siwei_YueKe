...
var _default = {
  ...
  methods: {
              ...
              case 6:
                try {
                  ...
                  if (!uniCloud.hasInit) {
                    ...
                    uniCloud.init({
                      provider: 'aliyun',
                      spaceId: _this.globalData.$spaceId,
                      clientSecret: '6YQCnJGxPGKuluPbkDTiyg==',
    ...
    // 初始化数据库
    initAppDatabase: function initAppDatabase() {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
        var retryCount, maxRetries, success, lastError, result, errorMsg;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 6:
                ...
                console.log("\u7B2C".concat(retryCount, "\u6B21\u91CD\u8BD5\u521D\u59CB\u5316\u6570\u636E\u5E93..."));
                // 等待一小段时间再重试
                _context2.next = 12;
              ...
              case 22:
                errorMsg = result && result.result ? result.result.message : '未知错误';
              ...
              case 26:
                ...
                retryCount++;
                console.warn("\u521D\u59CB\u5316\u6570\u636E\u5E93\u5931\u8D25 (".concat(retryCount, "/").concat(maxRetries, "):"), _context2.t0.message);
              case 31:
                _context2.next = 6;
                break;
              case 33:
              ...
              case 39:
                ...
                console.error('应用数据库初始化出错:', _context2.t1);
                uni.showToast({
                  title: '初始化失败，使用本地数据',
                  icon: 'none',
                  duration: 2000
