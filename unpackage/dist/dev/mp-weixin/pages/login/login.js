            ...
            switch (_context.prev = _context.next) {
              ...
              case 10:
                ...
                if (openidRes.result && openidRes.result.code === 0 && openidRes.result.data) {
                  ...
                  // 有了openid后尝试自动登录
                  if (_this5.loginState.openid) {
                    _this5.autoLoginWithOpenid();
                  }
                }
                _context.next = 18;
                break;
