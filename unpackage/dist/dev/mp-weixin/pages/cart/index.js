...
var _default = {
  ...
  methods: {
    // 添加一个安全地获取数组元素的辅助函数
    safeGetArrayItem: function safeGetArrayItem(arr) {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 23:
                ...
                if (res && res.code === 0) {
                  ...
                  console.log('处理后的收藏列表:', _this.favoriteList);
                } else {
                  uni.showToast({
                    title: '获取购物车列表失败',
                    icon: 'none'
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 7:
                ...
                // 直接预约课程，传递字符串格式的ID
                courseId = (0, _typeof2.default)(item.itemId) === 'object' ? item.itemId._id || item.itemId.id || '' : String(item.itemId || '');
                _context3.next = 11;
                return _this4.submitBooking(courseId);
              case 11:
              case "end":
    ...
    batchBook: function batchBook() {
      ...
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
        var selectedCourses, successCount, failCount, _iterator, _step, course, courseId, result, message;
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 20:
                _context4.next = 22;
                return _this5.submitBooking(courseId, false);
              case 22:
              ...
              case 53:
                ...
                console.error('批量预约过程中发生异常:', _context4.t2);
                uni.hideLoading();
                uni.showToast({
                  title: '预约失败，请稍后重试',
                  icon: 'none'
        ...
        }, _callee4, null, [[8, 53, 58, 61], [10, 41, 44, 47], [14, 33]]);
      }))();
    },
    // 提交预约
    ...
    checkCourseConflict: function checkCourseConflict(course, userId) {
      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6() {
        var _bookedCoursesRes$res, bookedCoursesRes, conflictResult, courseCalendarUtils, handleCourseConflictCheck, bookedCourses, _iterator2, _step2, booking, db, scheduleRes, scheduleData, courseIds, courseRes, courseData, courseMap, _iterator3, _step3, schedule, existingCourse, validTimeSlots, startTimes, endTimes, firstSlot, firstStart, firstEnd;
        return _regenerator.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.prev = 0;
                console.log('开始检查课程冲突，课程:', (course === null || course === void 0 ? void 0 : course.title) || (course === null || course === void 0 ? void 0 : course.courseTitle) || '未命名课程', '用户ID:', userId);
              ...
              case 4:
                ...
                console.log('获取用户预约结果:', JSON.stringify(bookedCoursesRes === null || bookedCoursesRes === void 0 ? void 0 : bookedCoursesRes.result));
                conflictResult = {
                  hasConflict: false,
                  conflictCourses: []
                }; // 安全地加载工具模块
                courseCalendarUtils = null;
                _context6.prev = 8;
                courseCalendarUtils = __webpack_require__(/*! @/utils/courseCalendar.js */ 117);
                _context6.next = 16;
                break;
              case 12:
                _context6.prev = 12;
                _context6.t0 = _context6["catch"](8);
                console.error('加载courseCalendar模块失败:', _context6.t0);
              ...
              case 16:
                ...
                handleCourseConflictCheck = function handleCourseConflictCheck(existingCourse) {
                  ...
                  console.log('检查课程冲突 - 已预约课程:', (existingCourse === null || existingCourse === void 0 ? void 0 : existingCourse.title) || (existingCourse === null || existingCourse === void 0 ? void 0 : existingCourse.courseTitle) || '未命名课程');
                  try {
                ...
                if (bookedCoursesRes !== null && bookedCoursesRes !== void 0 && (_bookedCoursesRes$res = bookedCoursesRes.result) !== null && _bookedCoursesRes$res !== void 0 && _bookedCoursesRes$res.data) {
                  bookedCourses = bookedCoursesRes.result.data; // 确保bookedCourses是数组
              ...
              case 24:
                ...
                scheduleData = scheduleRes === null || scheduleRes === void 0 ? void 0 : scheduleRes.data;
                ...
                courseIds = scheduleData.map(function (schedule) {
                  return schedule === null || schedule === void 0 ? void 0 : schedule.courseId;
                }).filter(function (id) {
                  return id;
                });
              ...
              case 32:
                ...
                courseData = courseRes === null || courseRes === void 0 ? void 0 : courseRes.data;
                if (Array.isArray(courseData) && courseData.length > 0) {
                  ...
                  try {
                    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                      ...
                      if (schedule !== null && schedule !== void 0 && schedule.courseId && courseMap[schedule.courseId]) {
                        existingCourse = courseMap[schedule.courseId]; // 检查timeSlots是否有冲突
                        if (Array.isArray(schedule === null || schedule === void 0 ? void 0 : schedule.timeSlots) && schedule.timeSlots.length > 0) {
                          // 从timeSlots提取上课时间范围
                          validTimeSlots = schedule.timeSlots.filter(function (slot) {
                            return slot && slot.status !== 'cancelled';
                          });
                          if (validTimeSlots.length > 0) {
                            try {
                              // 为course添加必要的时间字段
                              startTimes = validTimeSlots.map(function (s) {
                                return new Date(s.start).getTime();
                              }).filter(function (t) {
                                return !isNaN(t);
                              });
                              endTimes = validTimeSlots.map(function (s) {
                                return new Date(s.end).getTime();
                              }).filter(function (t) {
                                return !isNaN(t);
                              });
                              if (startTimes.length > 0 && endTimes.length > 0) {
                                existingCourse.startDate = new Date(Math.min.apply(Math, (0, _toConsumableArray2.default)(startTimes)));
                                existingCourse.endDate = new Date(Math.max.apply(Math, (0, _toConsumableArray2.default)(endTimes)));
              ...
              case 38:
                ...
                console.error('获取课程日程表失败:', _context6.t1);
              case 41:
                return _context6.abrupt("return", conflictResult);
              case 44:
                _context6.prev = 44;
                _context6.t2 = _context6["catch"](0);
                console.error('检查课程冲突出错:', _context6.t2);
    ...
    showConflictDialog: function showConflictDialog(conflictResult, course, userId) {
      ...
      var conflictCourses = Array.isArray(conflictResult === null || conflictResult === void 0 ? void 0 : conflictResult.conflictCourses) ? conflictResult.conflictCourses : [conflictResult.conflictCourses].filter(Boolean);
      if (!conflictCourses || conflictCourses.length === 0) {
        console.warn('没有有效的冲突课程信息');
        return this.proceedWithBooking((course === null || course === void 0 ? void 0 : course._id) || (course === null || course === void 0 ? void 0 : course.id), userId);
      }

      // 构建冲突信息文本
      var courseCalendarUtils = __webpack_require__(/*! @/utils/courseCalendar.js */ 117);
      var conflictMessage = '您已预约的课程与此课程时间冲突：\n\n';
      conflictCourses.forEach(function (item, index) {
        if (!item || !item.course) return;
        var conflictCourse = item.course;
        conflictMessage += "".concat(index + 1, ". ").concat((conflictCourse === null || conflictCourse === void 0 ? void 0 : conflictCourse.title) || (conflictCourse === null || conflictCourse === void 0 ? void 0 : conflictCourse.courseTitle) || '未命名课程', "\n");
        if (conflictCourse !== null && conflictCourse !== void 0 && conflictCourse.startTime && conflictCourse !== null && conflictCourse !== void 0 && conflictCourse.endTime) {
          conflictMessage += "   \u65F6\u95F4\uFF1A".concat(conflictCourse.startTime, "-").concat(conflictCourse.endTime, "\n");
        }

        // 添加冲突日期
        if (Array.isArray(item === null || item === void 0 ? void 0 : item.conflictDates) && item.conflictDates.length > 0) {
          try {
            // 安全调用 formatDate 方法
            var formatDateSafe = function formatDateSafe(date) {
              if (!date) return '';
              if (typeof (courseCalendarUtils === null || courseCalendarUtils === void 0 ? void 0 : courseCalendarUtils.formatDate) === 'function') {
            ...
            var formattedDates = item.conflictDates.filter(Boolean).map(formatDateSafe).filter(Boolean);
                ...
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                      ...
                      // 用户确认继续预约
                      courseIdToUse = (course === null || course === void 0 ? void 0 : course.id) || (course === null || course === void 0 ? void 0 : course._id);
                      if (courseIdToUse) {
                        _context7.next = 6;
                        break;
                      }
                    ...
                    case 6:
                      _context7.next = 8;
                      return _this7.proceedWithBooking(courseIdToUse, userId);
                    case 8:
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 35:
                ...
                return _context8.abrupt("return", (res === null || res === void 0 ? void 0 : res.result) || {
                  success: false,
