            ...
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                if (_this3.selectedGradeGroup !== 'all') {
                  params.gradeGroup = _this3.selectedGradeGroup;
                }
                if (_this3.selectedSchool !== 'all') {
                  params.schoolId = _this3.selectedSchool;
                }
              ...
              case 10:
                ...
                if (result && result.data) {
                  if (_this3.page === 1) {
                    _this3.courseList = result.data;
                  } else {
                    _this3.courseList = [].concat((0, _toConsumableArray2.default)(_this3.courseList), (0, _toConsumableArray2.default)(result.data));
                  }
                  _this3.total = result.total || _this3.courseList.length;
