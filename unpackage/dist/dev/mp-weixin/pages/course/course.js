...
var _default = {
  ...
  onLoad: function onLoad() {
    ...
    // 获取筛选选项数据的Promise数组
    var promises = [this.getGradeOptions(), this.getSubjectOptions(), this.getTermOptions(), this.getClassTypeOptions(), this.getTeacherOptions(), this.getCoursePeriodOptions()];
