...
var _index2 = _interopRequireDefault(__webpack_require__(/*! ./pages/index/index.vue */ 85));
// @ts-ignore
...
/* harmony import */ var _index_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&lang=scss& */ 90);
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                res = _context2.sent;
                if (res.result && res.result.success) {
                  _this2.recommendCourses = res.result.data;
                } else {
                  // 临时使用模拟数据
