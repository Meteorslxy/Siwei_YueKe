...
var _index2 = _interopRequireDefault(__webpack_require__(/*! ./pages/index/index.vue */ 93));
// @ts-ignore
...
/* harmony import */ var _index_vue_vue_type_template_id_57280228___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=57280228& */ 94);
...
/* harmony import */ var _index_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.vue?vue&type=style&index=0&lang=scss& */ 98);
...
var render = function () {
  ...
  var l1 = _vm.__map(_vm.recommendCourses, function (item, index) {
    var $orig = _vm.__get_orig(item)
    var m1 = _vm.getTeacherAvatar(item)
    return {
      $orig: $orig,
      m1: m1,
    }
  ...
  methods: {
    ...
    formatCourseDateAndTime: function formatCourseDateAndTime(startDate, endDate, startTime, endTime) {
      ...
      if (startTimeFormatted && endTimeFormatted) {
        ...
        if (result) {
          result += " ".concat(startTimeFormatted);
        } else {
    ...
    // 新闻详情页导航
    navigateToNewsDetail: function navigateToNewsDetail(news) {
      ...
      // 尝试所有可能的ID字段
      var newsId = news._id || news.id || news.newsId;
      console.log('使用的新闻ID:', newsId);
      if (!newsId) {
        console.error('无法找到新闻ID');
        // 显示模拟新闻详情
        uni.navigateTo({
          url: "/pages/news/detail?id=mock_news_".concat(Date.now()),
      ...
      // 使用ID参数跳转到详情页
      var url = "/pages/news/detail?id=".concat(newsId);
