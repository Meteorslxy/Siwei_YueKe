      ...
      <view class="menu-section" v-else>
        ...
        <view class="menu-group">
          ...
          <view class="menu-content">
            <view class="menu-item" @click="navigateTo('/pkgs/user/booking?status=all')">
            ...
            <view class="menu-item" @click="navigateTo('/pkgs/user/booking?status=expired')">
            ...
            <view class="menu-item" @click="navigateTo('/pkgs/user/booking?status=canceled')">
