    ...
    <view class="user-info-section">
      ...
      <view class="user-info">
        ...
        <view class="user-detail">
          ...
          <button v-if="hasUserInfo" class="edit-profile-btn" @click="navigateTo('/pkgs/user/profile/index')">编辑资料</button>
        </view>
      </view>
    </view>
    ...
    <view class="menu-section" v-else>
      ...
      <view class="menu-group">
        ...
        <view class="booking-tab-wrapper">
          <view class="booking-tabs">
            <view class="booking-tab-item" @click="navigateTo('/pkgs/user/booking?status=all')">
            ...
            <view class="booking-tab-item" @click="navigateTo('/pkgs/user/booking?status=usable')">
            ...
            <view class="booking-tab-item" @click="navigateTo('/pkgs/user/booking?status=expired')">
            ...
            <view class="booking-tab-item" @click="navigateTo('/pkgs/user/booking?status=canceled')">
      ...
      <view class="menu-group">
        ...
        <view class="menu-content grid-layout">
          ...
          <view class="menu-item" @click="navigateTo('/pkgs/user/calendar')">
          ...
          <view class="menu-item" @click="navigateTo('/pkgs/user/booking?status=usable')">
      ...
      <view class="menu-group">
        ...
        <view class="menu-content left-aligned-layout">
          ...
          <view class="menu-item" @click="navigateTo('/pkgs/user/about/index')">
          ...
          <view class="menu-item" @click="navigateTo('/pkgs/user/setting/index')">
...
// 导入token工具类
import { getToken, isTokenValid, clearToken, getUserId } from '@/utils/token.js'
              ...
              try {
                ...
                if (info && info.keys) {
                  const userRelatedKeys = info.keys.filter(key => 
                    ...
                    key.toLowerCase().includes('openid') ||
                    key.toLowerCase().includes('wx_') ||
    ...
    testUniIdPages(type) {
      ...
      switch (type) {
        case 'login':
          ...
          // 设置当前页为重定向目标
          const redirectUrl = encodeURIComponent('/pkgs/user/user');
